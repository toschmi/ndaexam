...
\PY{k}{def} \PY{n+nf}{ps}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{s}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{pn}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{l+s+sd}{        pn [normalize power spectrum]}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Output:}
...
\PY{k}{def} \PY{n+nf}{filt}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{bt}\PY{p}{,}\PY{n}{c}\PY{p}{,}\PY{n}{fs}\PY{p}{)}\PY{p}{:}
    \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
\PY{l+s+sd}{    Filters time series using low\PYZhy{}, high\PYZhy{}, or band\PYZhy{}pass filters.}
\PY{l+s+sd}{    }
\PY{l+s+sd}{    Input:}
\PY{l+s+sd}{        x  [time series]}
\PY{l+s+sd}{        bt [filter type, i.e. \PYZsq{}low\PYZsq{}, \PYZsq{}high\PYZsq{}, or \PYZsq{}band\PYZsq{}]}
...
\PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
    ...
    \PY{n}{b}\PY{p}{,}\PY{n}{a} \PY{o}{=} \PY{n}{signal}\PY{o}{.}\PY{n}{butter}\PY{p}{(}\PY{n}{o}\PY{p}{,}\PY{n}{cn}\PY{p}{,}\PY{n}{btype}\PY{o}{=}\PY{n}{bt}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{ac}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{tau}\PY{p}{)}\PY{p}{:}
    \PY{k}{if} \PY{n}{tau} \PY{o}{==} \PY{l+m+mi}{0}\PY{p}{:}
        \PY{n}{x\PYZus{}c} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{cov}\PY{p}{(}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{x\PYZus{}v} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{var}\PY{p}{(}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{x}\PY{p}{)}\PY{p}{)}
    \PY{k}{elif} \PY{n}{tau} \PY{o}{\PYZgt{}} \PY{l+m+mi}{0}\PY{p}{:}
        \PY{n}{x\PYZus{}o} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{p}{:}\PY{o}{\PYZhy{}}\PY{n}{tau}\PY{p}{]}
        \PY{n}{x\PYZus{}l} \PY{o}{=} \PY{n}{x}\PY{p}{[}\PY{n}{tau}\PY{p}{:}\PY{p}{]}
        \PY{n}{x\PYZus{}c} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{cov}\PY{p}{(}\PY{p}{(}\PY{n}{x\PYZus{}o}\PY{p}{,}\PY{n}{x\PYZus{}l}\PY{p}{)}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{x\PYZus{}v} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{var}\PY{p}{(}\PY{p}{(}\PY{n}{x\PYZus{}o}\PY{p}{,}\PY{n}{x\PYZus{}l}\PY{p}{)}\PY{p}{)}
    \PY{k}{return} \PY{n}{x\PYZus{}c}\PY{o}{/}\PY{n}{x\PYZus{}v}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{fg}\PY{p}{,}\PY{n}{ax} \PY{o}{=} \PY{n}{pl}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{sharex}\PY{o}{=}\PY{k+kc}{True}\PY{p}{,}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{15}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{,}\PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{300}\PY{p}{)}
...
\PY{n}{ax}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{o}{.}\PY{n}{set\PYZus{}title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{NGRIP}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{tau} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{30}\PY{p}{)}
\PY{n}{x\PYZus{}ac} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{tau}\PY{p}{)}\PY{p}{,} \PY{n}{dtype}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{float}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

\PY{k}{for} \PY{n}{i}\PY{p}{,} \PY{n}{tau\PYZus{}i} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n}{tau}\PY{p}{)}\PY{p}{:}
    \PY{n}{x\PYZus{}ac}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{=} \PY{n}{ac}\PY{p}{(}\PY{n}{x\PYZus{}bp}\PY{p}{,} \PY{n}{tau\PYZus{}i}\PY{p}{)}

\PY{n}{pl}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{tau}\PY{p}{,}\PY{n}{x\PYZus{}ac}\PY{p}{)}
\PY{n}{pl}\PY{o}{.}\PY{n}{axhline}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
<matplotlib.lines.Line2D at 0x1c23fe9d90>
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{rm\PYZus{}bp} \PY{o}{=} \PY{n}{rc}\PY{o}{.}\PY{n}{rp}\PY{p}{(}\PY{n}{x\PYZus{}bp}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{tau}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{,} \PY{n}{threshold\PYZus{}by}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{fan}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
\PY{n}{rt}\PY{p}{,} \PY{n}{rr} \PY{o}{=} \PY{n}{rrt}\PY{p}{(}\PY{n}{rm\PYZus{}bp}\PY{p}{,} \PY{l+m+mi}{50}\PY{o}{*}\PY{l+m+mf}{1e\PYZhy{}3}\PY{p}{)}
...
\PY{n}{pe}\PY{p}{,} \PY{n}{pse} \PY{o}{=} \PY{n}{ps}\PY{p}{(}\PY{n}{rt}\PY{p}{,} \PY{n}{rr}\PY{p}{,} \PY{l+m+mi}{50} \PY{o}{*} \PY{l+m+mf}{1e\PYZhy{}3}\PY{p}{,} \PY{n}{pn}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\PY{n}{px}\PY{p}{,} \PY{n}{psx} \PY{o}{=} \PY{n}{ps}\PY{p}{(}\PY{n}{t}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{l+m+mi}{50} \PY{o}{*} \PY{l+m+mf}{1e\PYZhy{}3}\PY{p}{,} \PY{n}{pn}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
